...
# a few bits were extracted from (https://www.youtube.com/watch?v=8iCqlFyFu2s)
...
def product_detail(request, product_id):
    ...
    if request.method == "POST":
        ...
        if content:
            ...
            messages.error(
                request, "Content is required for submitting a review.")
...
def review_edit(request, review_id):
    ...
    return render(
        request, 'products/review_edit.html', {'form': form, 'review': review})
